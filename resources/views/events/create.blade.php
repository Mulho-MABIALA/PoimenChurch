<x-app-layout>
    <x-slot name="title">Nouvel Événement - {{ config('app.name') }}</x-slot>
    ...
    <div class="max-w-4xl">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
            <h2 class="text-xl font-bold text-gray-900 mb-6">Créer un nouvel événement</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="2"
                                      ...
                                      placeholder="Une brève description de l'événement...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="content" id="content" rows="5"
                                      ...
                                      placeholder="Description complète, programme, informations pratiques...">{{ old('content') }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="mt-1 text-sm text-gray-500">JPG, PNG ou GIF. Max 2 Mo.</p>
                            @error('image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" id="address" rows="2"
                                      class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20"
                                      placeholder="Adresse détaillée...">{{ old('address') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="registration_fee" id="registration_fee" value="{{ old('registration_fee') }}"
                                   min="0" step="100"
                                   class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20"
                                   placeholder="0">
                        </div>
