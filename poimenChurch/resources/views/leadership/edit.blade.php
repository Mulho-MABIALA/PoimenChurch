<x-app-layout>
    <x-slot name="title">Modifier {{ $leadership->name }} - {{ config('app.name') }}</x-slot>
    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
            <h2 class="text-xl font-bold text-gray-900 mb-6">Modifier le membre</h2>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $leadership->title) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="bio" id="bio" rows="4"
                                      class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">{{ old('bio', $leadership->bio) }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            @if($leadership->photo)
                                <div class="flex items-center gap-4 mb-3">
                                    ...
                                    <p class="text-sm text-gray-500">Photo actuelle. Choisissez un nouveau fichier pour la remplacer.</p>
                                </div>
                            @endif
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="url" name="facebook_url" id="facebook_url" value="{{ old('facebook_url', $leadership->facebook_url) }}"
                        ...
                        <div>
                            ...
                            <input type="url" name="twitter_url" id="twitter_url" value="{{ old('twitter_url', $leadership->twitter_url) }}"
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $leadership->display_order) }}"
                                   min="0"
                        ...
                        <div class="flex flex-col gap-4 pt-1">
                            <div class="flex items-center">
                                <input type="checkbox" name="is_senior_pastor" id="is_senior_pastor" value="1"
                                       {{ old('is_senior_pastor', $leadership->is_senior_pastor) ? 'checked' : '' }}
