<x-app-layout>
    <x-slot name="title">Nouveau Temoignage - {{ config('app.name') }}</x-slot>

    @section('page-title', 'Nouveau Temoignage')
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
            <h2 class="text-xl font-bold text-gray-900 mb-6">Creer un nouveau temoignage</h2>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="author_role" id="author_role" value="{{ old('author_role') }}"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-sm text-gray-500">JPEG, PNG ou WebP. Max 2Mo.</p>
                            </div>
                        </div>
                        @error('author_photo')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="5"
                                  ...
                                  placeholder="Partagez le temoignage...">{{ old('content') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="testimonial_date" id="testimonial_date" value="{{ old('testimonial_date') }}"
                                   class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
