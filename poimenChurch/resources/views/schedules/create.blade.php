<x-app-layout>
    <x-slot name="title">Nouvel Horaire - {{ config('app.name') }}</x-slot>

    @section('page-title', 'Nouvel Horaire')
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
            <h2 class="text-xl font-bold text-gray-900 mb-6">Créer un nouvel horaire</h2>
                        ...
                        <div>
                            ...
                            <select name="icon_color" id="icon_color"
                                ...
                                @foreach($colors as $key => $label)
                                    <option value="{{ $key }}" {{ old('icon_color', 'primary') === $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
